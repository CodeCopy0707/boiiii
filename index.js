...
setInterval(async () => {
  ...
  try {
    await axios.get(`https://github-bot-individualfreelancer-ef01b3f9.koyeb.app/`);
    console.log("Ping sent to koyeb bot app to keep it alive!");
  } catch (error) {
    console.error("Error pinging koyeb app:", error.message);
  }
}, 30000); // 30 seconds interval
